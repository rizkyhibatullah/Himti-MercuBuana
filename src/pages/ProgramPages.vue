...
const allPrograms = [
  ...
  },
  {
    ...
    // UBAH LINK DARI '#' MENJADI PATH ROUTER
    link: '/program/company-visit',
    isExternal: false,
  },
  {
    id: 5,
...
<template>
  ...
  >
    <div
      ...
      style="
        ...
        background:
          radial-gradient(
            circle at 10% 20%,
            rgba(120, 39, 231, 0.45) 0%,
            transparent 45%
          ),
          radial-gradient(
            circle at 90% 80%,
            rgba(139, 61, 168, 0.45) 0%,
            transparent 45%
          ),
          #180d2a;
    ...
    <div
      class="container relative z-10 mx-auto flex min-h-screen flex-col items-center justify-center px-4 pb-12 pt-24"
    >
      <div class="flex w-full flex-1 flex-col items-center justify-center">
        <div
          class="mx-auto flex w-full max-w-6xl flex-col items-center justify-center text-center font-bold text-white"
        >
          <h1
            class="font-poppins text-[24px] font-bold leading-tight tracking-tight sm:text-[28px] md:text-[40px] lg:text-[40px]"
          >
            <span
              >Rangkaian Program
        ...
        <button
          ...
          class="mx-auto mt-6 inline-block rounded-2xl bg-main-2 px-10 py-4 text-base font-bold text-white transition-colors hover:bg-main-4 focus:outline-none focus:ring-2 focus:ring-purple-500 md:text-lg"
          data-aos="fade-up"
          data-aos-delay="100"
        >
      ...
      <div class="relative z-10 flex h-24 items-center justify-center">
        <div class="bounce-animation cursor-pointer" @click="scrollToProgram">
    ...
    <div
      id="program-content"
      class="relative z-10 flex-grow bg-main-1 pb-20 pt-10"
    >
      <div class="container mx-auto px-4">
        <div class="text-center md:text-left">
          <div class="mb-[37px] inline-block text-left" data-aos="fade-right">
            <h1
              class="mb-6 text-3xl font-bold leading-tight text-white md:text-5xl"
            >
              Program
            </h1>
          ...
          <div
            class="flex flex-wrap justify-center gap-4 pb-4 md:gap-[40px]"
            data-aos="fade-left"
          >
            <button
              v-for="tab in tabs"
        ...
        <div v-if="filteredPrograms.length > 0" class="group relative mt-8">
          ...
          <div
            ref="sliderContainer"
            class="scrollbar-hide flex w-full select-none snap-x flex-nowrap gap-6 overflow-x-auto scroll-smooth pb-14 pr-10"
          ...
          >
            <div
              ...
              :key="program.id"
              class="relative flex w-[85vw] flex-shrink-0 snap-center flex-col justify-between rounded-2xl border border-main-4 bg-gray-900 p-6 shadow-2xl transition-all duration-300 sm:w-[340px]"
              data-aos="fade-up"
            >
              <div>
                ...
                <ul class="mb-4 space-y-2">
                  ...
                  >
                    ...
                    <span class="ml-2 line-clamp-2 text-sm text-gray-200">{{
                      feature
                    }}</span>
                  </li>
                </ul>
